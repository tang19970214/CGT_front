  ...
  <section class="max-w-[1080px] px-3 md:px-6 lg:px-0">
    ...
    <div class="w-full grid grid-cols-1 gap-3 mt-3">
      ...
      <div class="relative w-full mx-auto">
        ...
        <div class="absolute top-0 left-0 w-full h-full flex items-center justify-center">
          <div class="min-w-[80px] max-w-[80px] min-h-[80px] max-h-[80px] bg-[#2F80ED] rounded-full flex items-center justify-center cursor-pointer transition duration-300 hover:bg-opacity-80" @click="openVideoModal('https://www.youtube.com/embed/aabcBODpbWA', '【真空式脫泡攪拌機】攪拌分散，除泡效果')">
            <fa class="text-white text-5xl ml-1.5" :icon="['fas', 'play']" />
          </div>
        </div>
      </div>
      ...
      <div class="relative w-full mx-auto">
        <img width="100%" src="~/static/images/youtubeEx2.jpg" alt="【真空式脫泡攪拌機】大容量材料攪拌" />
        <div class="absolute top-0 left-0 w-full h-full flex items-center justify-center">
          <div class="min-w-[80px] max-w-[80px] min-h-[80px] max-h-[80px] bg-[#2F80ED] rounded-full flex items-center justify-center cursor-pointer transition duration-300 hover:bg-opacity-80" @click="openVideoModal('https://www.youtube.com/embed/Lzpxi6knvJo', '【真空式脫泡攪拌機】大容量材料攪拌')">
            <fa class="text-white text-5xl ml-1.5" :icon="['fas', 'play']" />
          </div>
        </div>
      </div>
